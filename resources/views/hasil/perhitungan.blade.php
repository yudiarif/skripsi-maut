...
@section('judul')
<i class="fas fa-fw fa-chart-area"></i> Data Perhitungan MAUT
@endsection
@section('isi')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                @foreach ($bobot as $b)
                                    <th class="text-center">{{ $b->bobot/$total ??'Tidak ada nilai' }}</th>
                                    @endforeach
                            </tbody>
                        </table>
                        ...
                        @endforeach
                            ...
                            <tr>
                                ...
                                @foreach ($kriteria as $k)
                                    <td class="text-center">{{ $report[$index][$k]['subkriteria_id'] ?? 'Tidak ada nilai'}}</td>
                                @endforeach
                            </tr>
                        @endforeach
                    </tr>
